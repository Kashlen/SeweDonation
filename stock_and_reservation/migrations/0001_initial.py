        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'size',
                    models.CharField(
                        choices=[('32', '32'), ('44', '44'), ('52', '52')], max_length=50, verbose_name='velikost'
                    ),
                ),
                (
                    'fabric_design',
                    models.CharField(
                        choices=[('uni', 'uni'), ('dívčí', 'dívčí'), ('chlapecký', 'chlapecký')],
                        max_length=50,
                        verbose_name='vzor',
                    ),
                ),
            ...
            fields=[
                (
                    ...
                    models.DateTimeField(
                        auto_created=True, default=django.utils.timezone.now, verbose_name='vytvořena dne'
                    ),
                ),
                (
                    'reservation_number',
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to='stock_and_reservation.itemvariation',
                        verbose_name='položka',
                    ),
                ),
                (
